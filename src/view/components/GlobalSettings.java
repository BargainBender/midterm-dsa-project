 ...
 * here you can see and change in information about, how dense the trees are.
 * and suchj
 * 
...
public class GlobalSettings extends JScrollPane {
	...
	public GlobalSettings() {
		...
		DropDownOption[] viewModeOptions = { new DropDownOption("Top down", MapViewMode.TOP_DOWN),
